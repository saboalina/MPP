...
public class Ticket implements org.apache.thrift.TBase<Ticket, Ticket._Fields>, java.io.Serializable, Cloneable, Comparable<Ticket> {
  ...
  public @org.apache.thrift.annotation.Nullable String touristsName; // required
  ...
  public Ticket setClientName(@org.apache.thrift.annotation.Nullable String clientName) {
    this.clientName = clientName;
    return this;
  }
  ...
  public Ticket setTouristsName(@org.apache.thrift.annotation.Nullable String touristsName) {
    this.touristsName = touristsName;
    return this;
  }
  ...
  public Ticket setClientAddress(@org.apache.thrift.annotation.Nullable String clientAddress) {
    this.clientAddress = clientAddress;
    return this;
  }
  ...
  public int compareTo(Ticket other) {
    ...
    lastComparison = Boolean.compare(isSetClientName(), other.isSetClientName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClientName()) {
    ...
    lastComparison = Boolean.compare(isSetTouristsName(), other.isSetTouristsName());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTouristsName()) {
    ...
    lastComparison = Boolean.compare(isSetClientAddress(), other.isSetClientAddress());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetClientAddress()) {
    ...
    lastComparison = Boolean.compare(isSetNoSeats(), other.isSetNoSeats());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNoSeats()) {
    ...
    lastComparison = Boolean.compare(isSetFlightId(), other.isSetFlightId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetFlightId()) {
