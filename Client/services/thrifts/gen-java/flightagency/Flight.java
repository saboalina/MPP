...
public class Flight implements org.apache.thrift.TBase<Flight, Flight._Fields>, java.io.Serializable, Cloneable, Comparable<Flight> {
  ...
  public java.lang.String departureTime; // required
  ...
  public Flight setDepartureDate(java.lang.String departureDate) {
    this.departureDate = departureDate;
    return this;
  }
  ...
  public Flight setDepartureTime(java.lang.String departureTime) {
    this.departureTime = departureTime;
    return this;
  }
  ...
  public Flight setAirport(java.lang.String airport) {
    this.airport = airport;
    return this;
  }
  ...
  public int compareTo(Flight other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDepartureTime()).compareTo(other.isSetDepartureTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDepartureTime()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetAvailableSeats()).compareTo(other.isSetAvailableSeats());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("Flight(");
    boolean first = true;
