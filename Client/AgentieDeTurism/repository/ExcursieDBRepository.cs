...
//         }
//
//         public List<Excursie> FindByNameAndTime(string name, DateTime min, DateTime max)
//         {
...
//             using (var comm = con.CreateCommand())
//             {
//                 comm.CommandText = "select * from Excursii where obiectivTuristic=@name and ora between @min and @max";
//                 
